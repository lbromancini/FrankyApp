...
import br.dev.lbromancini.mobile.frankyapp.ui.controle.placeholder.PlaceholderContent;
...
public class MovimentacaoFragment extends Fragment implements Response.ErrorListener, Response.Listener {
    ...
    public static MovimentacaoFragment newInstance(int columnCount) {
    ...
    public void onResponse(Object response) {
        try {
            ...
            if (jsonArray != null) {
                ...
                this.movimentacaos = new ArrayList<Movimentacao>();
                //preenchendo ArrayList com JSONArray recebido
                for (int i = 0, size = jsonArray.length(); i < size; i++) {
                    JSONObject jo = jsonArray.getJSONObject(i);
                    movimentacao = new Movimentacao(jo);
                ...
                if (view instanceof RecyclerView) {
                    ...
                    recyclerView.setAdapter(new ConMovimentacaoRecyclerViewAdapter(movimentacaos));
                }
